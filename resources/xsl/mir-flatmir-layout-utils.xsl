  ...
  <xsl:template name="mir.powered_by">
    ...
    <script type="text/javascript">
      $(document).ready(function(){
         $.cookieBar({
           fixed: true,
           message: 'Mit der Nutzung der Audio- und Video-Streams auf diesen Seiten erklären Sie, dass Sie die rechtlichen Hinweise gelesen haben und diese akzeptiere.',
